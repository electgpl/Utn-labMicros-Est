...
// Se muestra medición interna y externa en un LCD de 2x16
//*********************************************************************************************************
...
#use rs232(baud=600,parity=N,xmit=PIN_B2,rcv=PIN_B1,bits=8)    //Configuración de UART 600bps 8 N 1
...
#define STATUS PIN_A1                                          //Pin para analizar el status de la interrupt
...
// Saludo de Pantalla
//*********************************************************************************************************
void saludoPantalla(void){                                     //Función que realiza un saludo inicial
   lcd_gotoxy(1,1);                                            //Posiciona el cursor en la pantalla
   printf(lcd_putc," Est.Inalambrica");                        //Imprime mensaje renglón 1
   lcd_gotoxy(1,2);                                            //Posiciona el cursor en la pantalla
   printf(lcd_putc," v1.1  UTN INSPT");                        //Imprime mensaje renglón 2
...
void main(){                                                   //Función principal
   ...
   while(true){                                                //Loop principal infinito
      ...
      delay_ms(2000);                                          //Delay de Actualización
